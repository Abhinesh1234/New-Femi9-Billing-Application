...
class StorePartyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'display_name'                      => array_filter([
                ...
                $allowDuplicateNames ? null : Rule::unique('parties', 'display_name')->whereNull('deleted_at'),
            ]),
            ...
            // ── Classification ─────────────────────────────────────────────────
            'distribution_category_id'          => 'required_if:party_type,business|nullable|integer|exists:distribution_categories,id',
    ...
    public function messages(): array
    {
        return [
            ...
            'party_type.in'                             => 'Party type must be business or individual.',
            ...
            'distribution_category_id.required_if'     => 'Distribution category is required for business parties.',
            ...
            'contact_persons.max'                      => 'You can add a maximum of 20 contact persons.',
            ...
            'documents.*.file_name.required_with'      => 'Document file name is required.',
            'documents.*.file_path.required_with'      => 'Document file path is required.',
